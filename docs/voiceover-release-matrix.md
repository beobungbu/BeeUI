...
| 12 | Production-demo navigation | *(deferred — the production demo (`apps/demo`, #258–#263) now exists, but on-device VoiceOver acceptance of its flows is owner-gated RC (#248/#249), not run here)* | — | Deferred |
