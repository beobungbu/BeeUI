...
> **2026-09-06 owner decision (ADR-015, supersedes #407):** BeeUI 1.0 remains the product milestone name, while npm artifacts use plain SemVer starting at `0.86.2`. The #407 date label `0.86.2` was never published; every retained artifact and check that carried it is historical evidence and is not rewritten. See `docs/decisions/015-package-version-0-86-2.md`.
