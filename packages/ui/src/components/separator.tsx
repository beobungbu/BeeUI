...
export type SeparatorProps = Omit<ViewProps, 'role'> & {
  className?: string;
  /** When true (the default), marks the separator as not an accessibility element of its own and omits `role="separator"`, since a purely visual divider should not be announced. Set to false for a separator that conveys real structure. */
  decorative?: boolean;
