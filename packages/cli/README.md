...
**Release candidate:** this README ships with `@beemvp/beeui-cli@0.86.2-rc.3`. BeeUI release candidates are published under the explicit `@next` channel; during RC use it (or pin the exact version):
