...
const DOC_LIB_RE = /^scripts\/(?:component-docs-lib|component-props-lib|public-component-reference|public-pattern-reference|public-reference|public-guide-data|public-portal-shell|generate-production-pattern-usage|check-portal-pages-fresh|public-docs-a11y)\.mjs$/;
