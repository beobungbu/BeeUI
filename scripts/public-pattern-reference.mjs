...
export function collectPublicPatternViolations(rootDir = ROOT_DIR) {
  ...
  for (const pattern of manifest) {
    ...
    if (!fs.existsSync(path.join(rootDir, pattern.file))) violations.push(`${key}: source file is missing.`);
