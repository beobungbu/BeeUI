...
const NO_LANE_REQUIRED = [
  ...
  { prefix: 'scripts/__tests__/verify-release-tag', why: 'run by verify-fast via release-control-plane:test' },
  ...
  { prefix: 'scripts/__tests__/release-version-packages', why: 'unit-tests scripts/release/version-packages.mjs, which itself carries the release/releasePrep lane; run by pnpm release:prepare:test (chained into pnpm test)' },
  { prefix: 'scripts/__tests__/literal-audit', why: 'unit-tests scripts/release/literal-audit.mjs, which itself carries the release lane; run by pnpm release:literal-audit:test (chained into pnpm test)' },
