...
| Evaluate an Expo package consumer | [Expo](/docs/start/expo/) | isolated packed-package + Expo Metro export |
| Evaluate without Expo | [Bare React Native](/docs/start/bare-react-native/) | isolated packed-package + bare RN Metro bundles |
| Evaluate standalone Web | [Web](/docs/start/web/) | isolated packed-package + Vite/RNW production build |
...
Read [Provider & safe area](/docs/start/provider-safe-area/) for nested providers, overlay scopes, Toast ownership and edge rules.
