---
title: "Toast"
description: "Provider-scoped runtime for toast notifications, exposed via useToast (show/dismiss/dismissAll) with FIFO queueing and safe-area-aware stacking."
---

<!-- Generated by scripts/public-component-reference.mjs. Do not hand-edit. -->

Provider-scoped runtime for toast notifications, exposed via useToast (show/dismiss/dismissAll) with FIFO queueing and safe-area-aware stacking.
...
- **Roles this family assigns:** `button` — set in `toast.tsx` by the components themselves, not by the caller.
- **Accessibility states and properties it sets:** `accessibilityLabel`, `accessibilityLiveRegion`, `accessible` — read from `toast.tsx`.
...
These are the parts of the typechecked **runtime Showcase fixture behind this live preview** — [`apps/showcase/component-gallery/component-gallery.tsx`](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/component-gallery/component-gallery.tsx), 1103 lines — where **Toast** is actually used: 54 lines in 3 places. Each block is copied verbatim from the line range named above it, so it is the same executable source, not a retelling of it. The rest of that file exercises other families and is not reproduced here.
