---
title: "Tabs"
description: "Controlled tab set sharing state across list/triggers/content; inactive panels are not mounted."
---
...
```tsx
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@beemvp/beeui-ui';
```
...
- **Style axes:** none of its own — its appearance comes from tokens and your own classes; it also carries `Omit<PressableProps, 'accessibilityRole' | 'role' | 'children' | 'onPress'>`, `Omit<ViewProps, 'accessibilityRole' | 'role'>`, `Omit<ViewProps, 'children' | 'role'>`, `Omit<ViewProps, 'children'>`.
...
- [`basic`](/showcase/?surface=component&id=tabs&example=basic) — smallest meaningful complete usage
- [`states`](/showcase/?surface=component&id=tabs&example=states) — the states example

The Showcase links demonstrate Web behavior; use the native-preview guide for real simulator/emulator/device paths.

## Live Web preview

<div class="beeui-component-preview" data-component="tabs">
  <iframe
    src="/showcase/?surface=component&id=tabs&example=basic&embed=1"
    title="Live Web preview of Tabs"
    loading="lazy"
...
- **Family root / primary export:** `Tabs`
...
These are the parts of the typechecked **runtime Showcase fixture behind this live preview** — [`apps/showcase/component-gallery/component-gallery.tsx`](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/component-gallery/component-gallery.tsx), 1103 lines — where **Tabs** is actually used: 12 lines in 1 place. Each block is copied verbatim from the line range named above it, so it is the same executable source, not a retelling of it. The rest of that file exercises other families and is not reproduced here.
...
[lines 945–956](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/component-gallery/component-gallery.tsx#L945-L956):
...
- [Source](https://github.com/beobungbu/BeeUI/blob/main/packages/ui/src/components/tabs.tsx)
