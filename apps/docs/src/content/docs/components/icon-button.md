---
title: "Icon Button"
description: "44px icon-only action; an accessible label is required."
---
...
- [`basic`](/showcase/?surface=component&id=icon-button&example=basic) — smallest meaningful complete usage

The Showcase links demonstrate Web behavior; use the native-preview guide for real simulator/emulator/device paths.

## Live Web preview

<div class="beeui-component-preview" data-component="icon-button">
  <iframe
    src="/showcase/?surface=component&id=icon-button&example=basic&embed=1"
    title="Live Web preview of Icon Button"
    loading="lazy"
...
- **Family root / primary export:** `IconButton`
...
These are the parts of the typechecked **runtime Showcase fixture behind this live preview** — [`apps/showcase/component-gallery/component-gallery.tsx`](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/component-gallery/component-gallery.tsx), 1103 lines — where **Icon Button** is actually used: 15 lines in 1 place. Each block is copied verbatim from the line range named above it, so it is the same executable source, not a retelling of it. The rest of that file exercises other families and is not reproduced here.
...
- [Source](https://github.com/beobungbu/BeeUI/blob/main/packages/ui/src/components/icon-button.tsx)
