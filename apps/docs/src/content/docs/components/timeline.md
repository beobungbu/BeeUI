---
title: "Timeline"
description: "Read-only ordered history composition with semantic marker states; owns no workflow state."
---
...
- **Source:** [`packages/ui/src/components/timeline.tsx`](https://github.com/beobungbu/BeeUI/blob/main/packages/ui/src/components/timeline.tsx)
...
- **Roles this family assigns:** none set in `timeline.tsx`.
- **Accessibility states and properties it sets:** `accessibilityElementsHidden` — read from `timeline.tsx`.
...
- **Primary executable fixture:** [`apps/showcase/__tests__/navigation-data-patterns.test.tsx`](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/__tests__/navigation-data-patterns.test.tsx)
...
- **Additional fixture:** [`apps/showcase/patterns/commerce-social/screens/order-detail-screen.tsx`](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/patterns/commerce-social/screens/order-detail-screen.tsx)

### Addressable examples

Each link below opens the Showcase at that exact example, not at the top of the gallery:

- [`basic`](/showcase/?surface=component&id=timeline&example=basic) — smallest meaningful complete usage
- [`states`](/showcase/?surface=component&id=timeline&example=states) — the states example

The Showcase links demonstrate Web behavior; use the native-preview guide for real simulator/emulator/device paths.

## Live Web preview

<div class="beeui-component-preview" data-component="timeline">
  <iframe
    src="/showcase/?surface=component&id=timeline&example=basic&embed=1"
    title="Live Web preview of Timeline"
    loading="lazy"
...
- **Family root / primary export:** `Timeline`
...
These are the parts of the typechecked **runtime Showcase fixture behind this live preview** — [`apps/showcase/component-gallery/component-gallery.tsx`](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/component-gallery/component-gallery.tsx), 1103 lines — where **Timeline** is actually used: 20 lines in 1 place. Each block is copied verbatim from the line range named above it, so it is the same executable source, not a retelling of it. The rest of that file exercises other families and is not reproduced here.
...
[lines 1022–1041](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/component-gallery/component-gallery.tsx#L1022-L1041):
...
- [Source](https://github.com/beobungbu/BeeUI/blob/main/packages/ui/src/components/timeline.tsx)
