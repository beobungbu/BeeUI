...
- **Roles this family assigns:** `button`, `listitem` — set by the components themselves, not by the caller.
- **Accessibility states and properties it sets:** `accessibilityLabel`, `accessible`, `disabled`.
