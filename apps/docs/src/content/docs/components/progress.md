---
title: "Progress"
description: "Clamped determinate progress bar with native progressbar semantics."
---
...
- **Source:** [`packages/ui/src/components/progress.tsx`](https://github.com/beobungbu/BeeUI/blob/main/packages/ui/src/components/progress.tsx)

## Import

```tsx
import { Progress, progressVariants } from '@beemvp/beeui-ui';
```

There is no documented deep/private source import. For source ownership from a BeeUI checkout:

```bash
pnpm beeui add progress
```
...
- [`basic`](/showcase/?surface=component&id=progress&example=basic) — smallest meaningful complete usage

The Showcase links demonstrate Web behavior; use the native-preview guide for real simulator/emulator/device paths.

## Live Web preview

<div class="beeui-component-preview" data-component="progress">
  <iframe
    src="/showcase/?surface=component&id=progress&example=basic&embed=1"
    title="Live Web preview of Progress"
    loading="lazy"
...
- **Family root / primary export:** `Progress`
...
These are the parts of the typechecked **runtime Showcase fixture behind this live preview** — [`apps/showcase/component-gallery/component-gallery.tsx`](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/component-gallery/component-gallery.tsx), 1103 lines — where **Progress** is actually used: 19 lines in 1 place. Each block is copied verbatim from the line range named above it, so it is the same executable source, not a retelling of it. The rest of that file exercises other families and is not reproduced here.

Imports the examples below need (a filtered subset of the fixture's own top-level imports):

````tsx
import { Badge, Box, Card, Progress, Separator, Spinner, Text } from '@beemvp/beeui-ui';
````
...
- [Source](https://github.com/beobungbu/BeeUI/blob/main/packages/ui/src/components/progress.tsx)
