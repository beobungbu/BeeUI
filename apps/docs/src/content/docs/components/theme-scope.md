...
- **Style axes:** this family declares no variant or size prop of its own; it carries `(| { /** Semantic brand, resolved through `registry`. */ brand: RegistryBrand<Def>; /** Semantic appearance, resolved through `registry`. */ appearance: RegistryAppearance<Def>; theme?: undefined; } | { /** An already-resolved Uniwind runtime-theme name, validated against `registry`. */ theme: RegistryRuntimeTheme<Def>; brand?: undefined; appearance?: undefined; })`, whose styling props are declared there rather than here.
- **Class-name surfaces:** none declared by this family; any it accepts come from `(| { /** Semantic brand, resolved through `registry`. */ brand: RegistryBrand<Def>; /** Semantic appearance, resolved through `registry`. */ appearance: RegistryAppearance<Def>; theme?: undefined; } | { /** An already-resolved Uniwind runtime-theme name, validated against `registry`. */ theme: RegistryRuntimeTheme<Def>; brand?: undefined; appearance?: undefined; })`.
