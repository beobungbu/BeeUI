---
title: "Stat"
description: "Layout-only metric composition (label/value/help text) with no formatting or state ownership."
---
...
- **Source:** [`packages/ui/src/components/stat.tsx`](https://github.com/beobungbu/BeeUI/blob/main/packages/ui/src/components/stat.tsx)
...
Stateless layout-only metric composition (`StatLabel`/`StatValue`/`StatHelpText`); it owns no number formatting or state.
...
- **Roles this family assigns:** none set in `stat.tsx`.
- **Accessibility states and properties it sets:** none set in `stat.tsx`.
...
- **Style axes:** `tone` (8 values, inherited from `TextProps`).
...
- **Additional fixture:** [`apps/showcase/patterns/dashboard-finance/components/metric-card.tsx`](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/patterns/dashboard-finance/components/metric-card.tsx)
...
- [`basic`](/showcase/?surface=component&id=stat&example=basic) — smallest meaningful complete usage

The Showcase links demonstrate Web behavior; use the native-preview guide for real simulator/emulator/device paths.

## Live Web preview

<div class="beeui-component-preview" data-component="stat">
  <iframe
    src="/showcase/?surface=component&id=stat&example=basic&embed=1"
    title="Live Web preview of Stat"
    loading="lazy"
...
- **Family root / primary export:** `Stat`
...
These are the parts of the typechecked **runtime Showcase fixture behind this live preview** — [`apps/showcase/component-gallery/component-gallery.tsx`](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/component-gallery/component-gallery.tsx), 1103 lines — where **Stat** is actually used: 10 lines in 1 place. Each block is copied verbatim from the line range named above it, so it is the same executable source, not a retelling of it. The rest of that file exercises other families and is not reproduced here.
...
[lines 992–1001](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/component-gallery/component-gallery.tsx#L992-L1001):
...
- [Source](https://github.com/beobungbu/BeeUI/blob/main/packages/ui/src/components/stat.tsx)
