...
- **Roles this family assigns:** none set in `search-input.tsx`.
...
[lines 600–602](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/component-gallery/component-gallery.tsx#L600-L602):
