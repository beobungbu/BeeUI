...
- **Roles this family assigns:** none set in `search-input.tsx`; each element keeps the role of the primitive it renders.
- **Accessibility states and properties it sets:** none set in `search-input.tsx`.
