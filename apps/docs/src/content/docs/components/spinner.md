---
title: "Spinner"
description: "Native activity indicator with semantic tone mapping."
---
...
- **Source:** [`packages/ui/src/components/spinner.tsx`](https://github.com/beobungbu/BeeUI/blob/main/packages/ui/src/components/spinner.tsx)

## Import

```tsx
import { Spinner } from '@beemvp/beeui-ui';
```

There is no documented deep/private source import. For source ownership from a BeeUI checkout:

```bash
pnpm beeui add spinner
```
...
Stateless native activity indicator with semantic tone mapping; no controlled props.
...
- **Roles this family assigns:** none set in `spinner.tsx`; each element keeps the role of the primitive it renders.
- **Accessibility states and properties it sets:** `accessibilityLabel` — read from `spinner.tsx`.
...
- **Style axes:** none of its own — its appearance comes from tokens and your own classes; it also carries `Omit<ActivityIndicatorProps, 'color'>`.
...
- **Primary executable fixture:** [`apps/showcase/__tests__/issue-276-structural-status-a11y.test.tsx`](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/__tests__/issue-276-structural-status-a11y.test.tsx)
...
- [`basic`](/showcase/?surface=component&id=spinner&example=basic) — smallest meaningful complete usage
- [`variants`](/showcase/?surface=component&id=spinner&example=variants) — the variants example

The Showcase links demonstrate Web behavior; use the native-preview guide for real simulator/emulator/device paths.

## Live Web preview

<div class="beeui-component-preview" data-component="spinner">
  <iframe
    src="/showcase/?surface=component&id=spinner&example=basic&embed=1"
    title="Live Web preview of Spinner"
    loading="lazy"
...
- **Family root / primary export:** `Spinner`
...
These are the parts of the typechecked **runtime Showcase fixture behind this live preview** — [`apps/showcase/component-gallery/component-gallery.tsx`](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/component-gallery/component-gallery.tsx), 1074 lines — where **Spinner** is actually used: 6 lines in 1 place. Each block is copied verbatim from the line range named above it, so it is the same executable source, not a retelling of it. The rest of that file exercises other families and is not reproduced here.

[lines 556–561](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/component-gallery/component-gallery.tsx#L556-L561):
...
- [Source](https://github.com/beobungbu/BeeUI/blob/main/packages/ui/src/components/spinner.tsx)
