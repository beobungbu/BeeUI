...
Read from the screen file and the 2 pattern-local files it imports: `invoice-detail-screen.tsx`, `screen-shell.tsx`, `section-header.tsx`. Every fact below is scoped to those files and to nothing else.
