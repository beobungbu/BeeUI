...
- **Horizontal scrolling:** no `horizontal` scroll container in `payment-methods-screen.tsx`, `screen-shell.tsx`, `section-header.tsx`.
- **Width constraint:** `max-w-6xl` (`screen-shell.tsx`).
- **Breakpoint-prefixed utility classes:** none in `payment-methods-screen.tsx`, `screen-shell.tsx`, `section-header.tsx`.
- **Platform-prefixed utility classes:** none in `payment-methods-screen.tsx`, `screen-shell.tsx`, `section-header.tsx`.
- **Platform branching:** no `Platform.OS` or `Platform.select` call in `payment-methods-screen.tsx`, `screen-shell.tsx`, `section-header.tsx`.
- **Viewport measurement:** no `useWindowDimensions`, `Dimensions.get` or breakpoint hook in `payment-methods-screen.tsx`, `screen-shell.tsx`, `section-header.tsx`.
