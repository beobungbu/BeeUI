...
- [`empty`](/showcase/?surface=pattern&id=analytics&state=empty&embed=1) The same source is available at [`apps/showcase/patterns/dashboard-finance/screens/analytics-screen.tsx`](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/patterns/dashboard-finance/screens/analytics-screen.tsx).
