...
- **Horizontal scrolling:** no `horizontal` scroll container in `analytics-screen.tsx`, `mini-bar-chart.tsx`, `screen-shell.tsx`, `section-header.tsx`, `trend-indicator.tsx`.
- **Width constraint:** `max-w-6xl` (`screen-shell.tsx`).
- **Breakpoint-prefixed utility classes:** none in `analytics-screen.tsx`, `mini-bar-chart.tsx`, `screen-shell.tsx`, `section-header.tsx`, `trend-indicator.tsx`.
- **Platform-prefixed utility classes:** none in `analytics-screen.tsx`, `mini-bar-chart.tsx`, `screen-shell.tsx`, `section-header.tsx`, `trend-indicator.tsx`.
- **Platform branching:** no `Platform.OS` or `Platform.select` call in `analytics-screen.tsx`, `mini-bar-chart.tsx`, `screen-shell.tsx`, `section-header.tsx`, `trend-indicator.tsx`.
- **Viewport measurement:** no `useWindowDimensions`, `Dimensions.get` or breakpoint hook in `analytics-screen.tsx`, `mini-bar-chart.tsx`, `screen-shell.tsx`, `section-header.tsx`, `trend-indicator.tsx`.
