...
This screen exposes a single default state. The same source is available at [`apps/showcase/patterns/auth/screens/welcome-screen.tsx`](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/patterns/auth/screens/welcome-screen.tsx).
