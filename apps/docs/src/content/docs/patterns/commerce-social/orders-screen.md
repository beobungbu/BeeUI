...
- [`empty`](/showcase/?surface=pattern&id=orders&state=empty&embed=1) The same source is available at [`apps/showcase/patterns/commerce-social/screens/orders-screen.tsx`](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/patterns/commerce-social/screens/orders-screen.tsx).
