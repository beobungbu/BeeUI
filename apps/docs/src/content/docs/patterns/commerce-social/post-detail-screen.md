...
This screen exposes a single default state. The same source is available at [`apps/showcase/patterns/commerce-social/screens/post-detail-screen.tsx`](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/patterns/commerce-social/screens/post-detail-screen.tsx).
