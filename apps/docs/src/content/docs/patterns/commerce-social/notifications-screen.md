...
Read from the screen file and the 2 pattern-local files it imports: `notifications-screen.tsx`, `screen-shell.tsx`, `social-fixtures.ts`. Every fact below is scoped to those files and to nothing else.
