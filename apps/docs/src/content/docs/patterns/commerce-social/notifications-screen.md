...
- [`empty`](/showcase/?surface=pattern&id=notifications&state=empty&embed=1) The same source is available at [`apps/showcase/patterns/commerce-social/screens/notifications-screen.tsx`](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/patterns/commerce-social/screens/notifications-screen.tsx).
