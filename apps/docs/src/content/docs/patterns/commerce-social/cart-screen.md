...
- [`empty`](/showcase/?surface=pattern&id=cart&state=empty&embed=1) The same source is available at [`apps/showcase/patterns/commerce-social/screens/cart-screen.tsx`](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/patterns/commerce-social/screens/cart-screen.tsx).
