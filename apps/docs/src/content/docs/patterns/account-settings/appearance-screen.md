...
This screen exposes a single default state. The same source is available at [`apps/showcase/patterns/account-settings/screens/appearance-screen.tsx`](https://github.com/beobungbu/BeeUI/blob/main/apps/showcase/patterns/account-settings/screens/appearance-screen.tsx).
