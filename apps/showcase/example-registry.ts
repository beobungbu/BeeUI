...
const COMPONENT_FIXTURES: readonly [string, string][] = [
  ...
  ['avatar', MAIN_GALLERY],
  ['badge', 'apps/showcase/component-gallery/addressable-component-gallery.tsx'],
  ['bottom-action-bar', MAIN_GALLERY],
  ['box', 'apps/showcase/component-gallery/addressable-component-gallery.tsx'],
  ['breadcrumb', MAIN_GALLERY],
  ['button', MAIN_GALLERY],
  ['calendar', PUBLIC_DOC_FIXTURES],
  ['card', 'apps/showcase/component-gallery/addressable-component-gallery.tsx'],
  ...
  ['stack', 'apps/showcase/component-gallery/addressable-component-gallery.tsx'],
  ['stat', MAIN_GALLERY],
  ...
  ['tabs', MAIN_GALLERY],
  ['text', 'apps/showcase/component-gallery/addressable-component-gallery.tsx'],
