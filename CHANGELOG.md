...
- Anchored overlays now have accepted geometry and runtime kernels; public `Popover`, `DropdownMenu`, `Select`, and `Tooltip` remain separate component-level work with their own focus/accessibility contracts.
