...
- Anchored overlays now have accepted geometry/runtime kernels and a public `Popover`; `DropdownMenu`, `Select`, and `Tooltip` remain separate component-level work with their own keyboard/focus/accessibility contracts.
