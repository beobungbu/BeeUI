...
// There is no dependency on `@beemvp/beeui-ui` here at all — only the copied
// component source plus the `@beemvp/beeui-tokens` runtime dependency that
 ...
 * vertical slice) and Popover (anchored-overlay + @beemvp/beeui-tokens runtime
...
export function App() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 480, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <Text variant="body">Button and Popover below are local source copied by `beeui add`, not `@beemvp/beeui-ui`.</Text>
